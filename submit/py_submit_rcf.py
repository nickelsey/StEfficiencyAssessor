  ...
  with open(tmpfile,'w') as new_file:
    with open(file_path) as old_file:
      for line in old_file:
        ...
        elif line.find("ENTITY FITPTS") != -1 :
          new_file.write("<!ENTITY FITPTS \"" + str(nhit) + "\">\n")
        elif line.find("ENTITY FITFRAC") != -1 :
          new_file.write("<!ENTITY FITFRAC \"" + str(fitfrac) + "\">\n")
        else :
          new_file.write(line)
...
def main(args):
  ...
  for i in range(len(mu_list)) :
    ...
    print("min fit point fraction: " + args.fitfrac)
